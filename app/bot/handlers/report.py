...
from app.core.constants import ROLE_MANAGER, SURVEY_QUESTION_LABELS
...
def format_report_text(report) -> str:
    return (
        ...
        f"Общий процент: {report.summary.average_percent:.2f}%\n\n"
        ...
        f"По вопросам:\n"
        f"{SURVEY_QUESTION_LABELS['q1']}: Да={report.q1_stats.yes_count}, Нет={report.q1_stats.no_count}, "
        f"Да%={report.q1_stats.yes_percent:.2f}\n"
        f"{SURVEY_QUESTION_LABELS['q2']}: Да={report.q2_stats.yes_count}, Нет={report.q2_stats.no_count}, "
        f"Да%={report.q2_stats.yes_percent:.2f}\n"
        f"{SURVEY_QUESTION_LABELS['q3']}: Да={report.q3_stats.yes_count}, Нет={report.q3_stats.no_count}, "
        f"Да%={report.q3_stats.yes_percent:.2f}\n"
        f"{SURVEY_QUESTION_LABELS['q4']}: Да={report.q4_stats.yes_count}, Нет={report.q4_stats.no_count}, "
        f"Да%={report.q4_stats.yes_percent:.2f}\n\n"
